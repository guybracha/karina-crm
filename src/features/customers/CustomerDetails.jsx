...
// CustomerPhotos removed per request
import CloudImage from '@/components/CloudImage.jsx';
import { Modal } from 'react-bootstrap';
import UserAllLogos from '@/components/UserAllLogos.jsx';
        ...
        <div className="card">
          ...
          <div className="px-3 pb-3">
            ...
            <div className="d-flex justify-content-between align-items-center mb-2">
              <strong>Customer logos</strong>
              <small className="text-muted">Click any image to open/download</small>
            </div>
            <UserAllLogos uid={cust.firebaseUid || id} />
          </div>
        </div>
